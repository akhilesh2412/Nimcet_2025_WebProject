...
export const courseData: Course[] = [
  ...
  {
    id: 'complete-video-editing-course',
    ...
    subjects: [
      {
        ...
        videos: [
          ...
          { id: 'math-11-7', title: 'Binomial Theorem', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'hxPoUsmq7Xs' }] },
          { id: 'math-11-8', title: 'Sequence and Series', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'pVX8_vNbta4' }] },
          { id: 'math-11-9', title: 'Straight Lines', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'lRrHW6hfAiA' }] },
          { id: 'math-11-10', title: 'Introduction to 3D Geometry', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'iTV5LP5j17s' }] },
          { id: 'math-11-11', title: 'Probability', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: '5Ok1AkHBsnw' }] },
          { id: 'math-11-12', title: 'Limit and Derivatives', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'CHWhaAlo_ms' }] },
          { id: 'math-11-13', title: 'Statistics', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: '4LxrzD-MRBk' }] },
        ],
        dpps: [],
        notes: [],
        solutions: [],
    ...
    subjects: [
      {
        ...
        name: 'Maths',
        videos: [
          { id: 'math-12-1', title: 'Relations and Functions', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'Dsg2SwKQi-I' }] },
          { id: 'math-12-2', title: 'Inverse Trigonometric Functions', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'lsHZlZv3XsE' }] },
          { id: 'math-12-3', title: 'Matrices', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'JUhR0fwNPPs' }] },
          { id: 'math-12-4', title: 'Determinants', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'T3qYn52UXTw' }] },
          { id: 'math-12-5', title: 'Continuity and Differentiability', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'HG4M27VaM5Y' }] },
          { id: 'math-12-6', title: 'Application of Derivatives', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'DuWCTtNwvR4' }] },
          { id: 'math-12-7', title: 'Integrals', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'lV6oNc10j6Y' }] },
          { id: 'math-12-8', title: 'Application of the Integrals', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'CeMgWziF-eg' }] },
          { id: 'math-12-9', title: 'Differential Equations', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'JIXx-LOzBN0' }] },
          { id: 'math-12-10', title: 'Vectors', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'TcHMy0QppGY' }] },
          { id: 'math-12-11', title: 'Linear Programming', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'g0Kmgic5C54' }] },
          { id: 'math-12-12', title: 'Probability', description: 'Complete Chapter', sources: [{ type: 'youtube', videoId: 'P6VVruQReys' }] }
        ],
        dpps: [],
        notes: [],
        solutions: [],
